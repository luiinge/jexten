...
public class ModuleLayerTree {
	...
	private final Plugin plugin; // null for boot layer
	private final List<ModuleLayerTree> children;
	private final int depth;


	public ModuleLayerTree(Map<Plugin,ModuleLayer> pluginMap) {
	...
	private ModuleLayerTree(
		...
		Plugin plugin,
		int depth,
		Map<Plugin,ModuleLayer> pluginMap
	) {
		this.parent = parent;
	...
	public void forEach(ModuleLayerVisitor visitor) {
	...
	public String description() {
		return new ModuleLaterTreeToStringVisitor().toString(this);
	}
