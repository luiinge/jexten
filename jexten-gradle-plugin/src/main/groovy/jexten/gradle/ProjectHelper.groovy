...
import static jexten.gradle.JextenGradlePlugin.*

class ProjectHelper {

    private static final Logger LOG = LoggerFactory.getLogger('jexten.gradle')
    ...
    private collectDependencies() {
        ...
        for (def conf : project.configurations) {
            ...
            } else if (conf.name == CONFIGURATION_JEXTEN_PARENT) {
